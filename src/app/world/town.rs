...
use crate::world::{AreaId, ObjectiveKind, VendorId, area_def, quest_def, vendor_def};
use rand::RngExt;
...
impl App {
    ...
    pub fn shop_cycle_vendor(&mut self, dir: i32) {
        super::super::input::cycle_cursor(&mut self.vendor_cursor, dir, VendorId::ALL.len());
        self.shop_cursor = 0;
        self.detail_scroll = 0;
    }
