...
pub use proficiencies::{
    ...
    level_from_xp, level_progress_pct, major_study_plan, major_study_plan_for_xp,
    proficiency_level_from_xp, proficiency_progress_pct, proficiency_xp_for_level, study_plan,
